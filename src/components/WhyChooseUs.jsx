...
export default function WhyChooseUs() {
  return (
    <section className="py-16 px-6 bg-gray-50 dark:bg-neutral-900">
      <h2 className="text-3xl font-semibold text-center mb-12 text-neutral-900 dark:text-neutral-100">
        Why Choose Us
      </h2>
      <ul className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {features.map((feature, idx) => (
          <li
            key={idx}
            className="flex items-start bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-sm space-x-4"
          >
            <CheckCircleIcon className="h-8 w-8 text-emerald-500 mt-1 flex-shrink-0" />
            <div className="text-left">
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-neutral-100">
                {feature.title}
              </h3>
